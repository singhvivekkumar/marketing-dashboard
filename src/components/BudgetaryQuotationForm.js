...
const BudgetaryQuotationForm = () => {
  ...
  const statusOptions = ['Draft', 'Submitted', 'Under Review', 'Quoted', 'Won', 'Lost'];
  ...
  const onSubmit = (data) => {
    ...
    const formattedData = {
      ...
      estimatedValueWithoutGST: parseFloat(parseFloat(data.estimatedValueWithoutGST).toFixed(2)),
      estimatedValueWithGST: parseFloat(parseFloat(data.estimatedValueWithGST).toFixed(2)),
    ...
    console.log('Budgetary Quotation Data:', JSON.stringify(formattedData, null, 2));
  ...
  const handleDownloadJSON = () => {
    if (submittedData) {
      ...
      link.href = url;
      link.download = `budgetary-quotation-${submittedData.serialNumber}-${Date.now()}.json`;
      link.click();
      ...
      <Paper elevation={3} sx={{ p: { xs: 2, sm: 4 }, backgroundColor: '#ffffff' }}>
        <Box sx={{ textAlign: 'center', mb: 4 }}>
          ...
          <Typography variant="body2" color="text.secondary">
            Complete all required fields to submit budgetary quotation information
          </Typography>
        </Box>
              ...
              <Grid container spacing={3}>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <TextField
                        ...
                        fullWidth
                        required
                        error={!!errors.estimatedValueWithoutGST}
                        helperText={errors.estimatedValueWithoutGST?.message || 'Enter estimated value (2 decimals)'}
                        variant="outlined"
                        inputProps={{
                          step: '0.01',
                          min: '0'
                ...
                <Grid item xs={12} sm={6}>
                  <Controller
                    ...
                    control={control}
                    rules={{ 
                      required: 'Estimated Value with GST is required',
                      pattern: {
                        value: /^[0-9]+(\.[0-9]{1,2})?$/,
                        message: 'Please enter a valid number with max 2 decimals'
                      },
                    ...
                    render={({ field }) => (
                      <TextField
                        ...
                        fullWidth
                        required
                        error={!!errors.estimatedValueWithGST}
                        helperText={errors.estimatedValueWithGST?.message || 'Enter estimated value (2 decimals)'}
                        variant="outlined"
                        inputProps={{
                          step: '0.01',
                          min: '0'
