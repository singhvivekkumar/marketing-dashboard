...
const TPCRForm = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post("http://127.0.0.1:5000"+API, formattedData)
      .then((response) => {
  ...
  const handleDownloadJSON = () => {
    if (submittedData) {
      ...
      link.href = url;
      link.download = `domestic-leads-${submittedData.serialNumber
        }-${Date.now()}.json`;
      link.click();
  ...
  return (
    ...
    >
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={4}>
                    <Controller
                      ...
                      control={control}
                      rules={{ required: "Technology Parameters is required" }}
                      render={({ field }) => (
                        <TextField
                          {...field}
                          // type="number"
      ...
      {value === 1 && orderData !== undefined && (
        <TPCRDoucment ViewData={orderData} ServerIp={ServerIp} />
      )}
