...
function ViewBudgetaryQuotationData(props) {
  ...
  const handleDownloadFile = async (fileName, hardDiskFileName) => {
    try {
      ...
      tempLink.href = url;
      tempLink.download = `BQ_${fileName}.pdf`;
      ...
      console.error("Dowload error: ", error);
    }
  };
  ...
  //       // const tempLink = document.createElement("a");
  //       // tempLink.href = url;
  //       // tempLink.setAttribute("download", `BQ_${fileName}`); // Set the desired filename for the downloaded file
  //       // tempLink.download = `BQ-----------`
  //       // setPdfUrl(tempLink);
  //       // Append the <a> element to the body and click it to trigger the downl
  //       // document.body.appendChild(tempLink);
  //       // console.log("tempLink appendChild : ", tempLink)
  //       // tempLink.click();
  //       // setPdfUrl(tempLink);
  //       // tempLink.remove();
                                ...
                                <>
                                  ...
                                  {open && (
                                    <PdfViewerDialog
                                      ...
                                      hardDiskFileName={row.HardDiskFileName}
                                      ServerIp={ServerIp}
                                    />
                                  )}
                                </>
