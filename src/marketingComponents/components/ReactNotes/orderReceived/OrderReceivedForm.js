        ...
        tableArray.map(async (item) => {
          try {
            ...
            return {
              ...
              letterOfIntent: letterOfIntentDoc ? { ...letterOfIntentDoc }: null, //Use spread to copy and handle null
            };
          } catch (error) {
            console.error("Error fetching documents for item ID:", item.id, error);
