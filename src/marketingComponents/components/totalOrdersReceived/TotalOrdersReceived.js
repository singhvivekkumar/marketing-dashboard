...
const TotalOrdersReceived = () => {
  ...
  const defenceAndNonDefenceOptions = ["Defence", "Civil"];
  const statusOptions = [
  ...
  const onSubmit = (data) => {
    ...
    const formattedData = {
      ...
      submittedValueInCrWithGST: parseFloat(
        parseFloat(data.submittedValueInCrWithGST).toFixed(2)
      ),
      typeOfBid: data.typeOfBid,
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} sm={6}>
                    <Controller
                      ...
                      control={control}
                      rules={{ required: "Customer Order No is required" }}
                      render={({ field }) => (
                        <TextField
                          {...field}
                          ...
                          helperText={errors.customerOrderNo?.message}
                          sx={{
                            "& .MuiOutlinedInput-root": {
                              borderRadius: 3,
                              "&:hover": { boxShadow: "0 0 10px #bbdefb" },
              ...
              >
                ...
                <Grid item xs={12} md={3}>
                  <Controller
                    name="typeOfBid"
                    control={control}
                    rules={{ required: "Type of Bid is required" }}
                    render={({ field }) => (
                      <TextField
                        {...field}
                        select
                        fullWidth
                        label="Type of Bid"
                        error={!!errors.typeOfBid}
                        helperText={errors.typeOfBid?.message}
                        sx={{
                          "& .MuiOutlinedInput-root": {
                            borderRadius: 3,
                          },
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <TextField
                          ...
                          helperText={errors.deliverySchedule?.message}
                          sx={{
                            "& .MuiOutlinedInput-root": {
                              borderRadius: 3,
                            },
...
//       remarks: "", */}
  ...
  const leadColumns = [
    ...
    { id: "estimateValueInCrWithoutGST", label: "Estimate Value (CR, w/o GST)" },
    { id: "submittedValueInCrWithGST", label: "Submitted (CR, with GST)" },
    { id: "typeOfBid", label: "Type of Bid" },
        ...
        >
          ...
          >
            ...
            <TextField
              variant="outlined"
              size="small"
              placeholder="Search by title, type of bid, customer name..."
              value={searchTerm}
          ...
          >
            ...
            >
              ...
              <MenuItem value="submittedValueInCrWithGST">
                Submitted Value
              </MenuItem>
            </TextField>
                ...
                props.ViewData.data
                  .filter((row) => {
                    ...
                    const matchesSearch =
                      ...
                      row.customerOrderNo?.toLowerCase().includes(q) ||
                      row.typeOfBid?.toLowerCase().includes(q) ||
                      row.deliverySchedule?.toLowerCase().includes(q);
                  ...
                  .map((row) => (
                    ...
                    >
                      ...
                      {leadColumns.map((col) => {
                        ...
                        if (
                          col.id === "customerOrderNo" ||
                          col.id === "date" ||
                          col.id === "estimateValueInCrWithoutGST" ||
                          col.id === "submittedValueInCrWithGST" ||
                          col.id === "typeOfBid" ||
                          col.id === "deliverySchedule" ||
                          col.id === "qty"
                        ) {
                          return (
                            <TableCell
            ...
            <Box sx={{ mb: 3 }}>
              ...
              >
                {[
                  ...
                  { label: "customer Order No.", key: "customerOrderNo" },
...
function ExcelUploadAndValidate({ user, ServerIp }) {
  ...
  const handleFileUpload = (event) => {
    ...
    //projectTitle	customerName	customerAddress	leadOwner	defenceAndNonDefence	estimateValueInCrWithoutGST	submittedValueInCrWithoutGST	dateOfLetterSubmission	referenceNo	JSON_competitors	presentStatus
...
export default TotalOrdersReceived;
