          ...
          <Table stickyHeader aria-label="lead submitted table" size="small">
            <TableHead>
              <TableRow>
                ...
                <TableCell sx={headerCellStyle}>Business Domain</TableCell>
                <TableCell sx={headerCellStyle}>Value of EMD</TableCell>
                <TableCell sx={headerCellStyle}>
                  Estimate (CR, w/o GST)
                </TableCell>
                <TableCell sx={headerCellStyle}>
                ...
                <TableCell sx={headerCellStyle}>Tender Dated</TableCell>
                <TableCell sx={headerCellStyle}>
                  Letter Submission Date
                </TableCell>
                <TableCell sx={headerCellStyle}>Sole Consortium</TableCell>
                <TableCell sx={headerCellStyle}>Pre Bid Meeting Date Time</TableCell>
                <TableCell sx={headerCellStyle}>Competitors</TableCell>
                {/* all okay */}
                {/* <TableCell sx={headerCellStyle}>Reference No</TableCell> */}

                <TableCell sx={headerCellStyle}>Won/Lost Participated</TableCell>
                <TableCell sx={headerCellStyle}>Open Closed</TableCell>
                <TableCell sx={headerCellStyle}>Order Won Value In Cr Without GST</TableCell>
                <TableCell sx={headerCellStyle}>Present Status</TableCell>
                <TableCell sx={headerCellStyle}>Reason For Lossing Opp</TableCell>
              ...
              {filteredSortedData && filteredSortedData.length > 0 ? (
                filteredSortedData.map((row) => (
                  ...
                  >
                    ...
                    <TableCell align="left" sx={{ fontSize: 13,maxWidth: 180,
                        whiteSpace: "nowrap",
                        textOverflow: "ellipsis",
                        overflow: "hidden", }}>
