...
const App = () => {
  ...
  const tabsConfig = [
    { label: 'Lost Domestic Leads', icon: 'trending_down', formType: 'lostDomesticLeads' },
    { label: 'Domestic Order', icon: 'receipt', formType: 'domesticOrder' },
    { label: 'Budgetary Quotation', icon: 'price_check', formType: 'budgetaryQuotation' },
    { label: 'Lead Submitted', icon: 'check_circle', formType: 'leadSubmitted' },
    { label: 'Domestic Leads V2', icon: 'home_work', formType: 'domesticLeadsV2' },
    { label: 'Export Leads', icon: 'public', formType: 'exportLeads' },
    { label: 'CRM Leads', icon: 'contacts', formType: 'crmLeads' }
  ];
...
function LostDomesticLeadsForm({ onSubmit, onBack }) {
