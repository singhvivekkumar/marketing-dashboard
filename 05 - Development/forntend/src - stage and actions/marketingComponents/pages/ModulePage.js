...
import CreateLeadForm from '../components/createLead/CreateLeadForm'
...
// Cards
const menuItems = [
  { title: "Create Lead", icon: <GroupsIcon />, value: 0 },
  { title: "Domestic Leads", icon: <GroupsIcon />, value: 1 },
  { title: "Export Leads", icon: <PublicIcon />, value: 1 },
  { title: "CRM Leads", icon: <HubIcon />, value: 2 },
  { title: "Budgetary Quotation", icon: <RequestQuoteIcon />, value: 3 },
  { title: "Lead Submitted", icon: <AssignmentTurnedInIcon />, value: 4 },
    ...
    >
      ...
      {value !== null && (
        <Box px={{ xs: 2, sm: 4 }} position={"relative"}>
          ...
          {value === 0 && <DomesticLeadForm />}
          {value === 1 && <ExportLeadForm />}
          {value === 2 && <CRMLeadForm />}
          {value === 3 && <BudgetaryQuotationForm />}
          {value === 4 && <LeadSubmittedForm />}
