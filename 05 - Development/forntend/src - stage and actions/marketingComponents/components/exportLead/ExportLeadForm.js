...
const civilDefenceOptions = ["Defence", "Non Defence"];
...
const ExportLeadForm = () => {
  ...
  const [dynamicOptions, setDynamicOptions] = useState({
    ...
    defenceOrNonDefence: ["Non Defence", "Defence"],
    wonLostParticipated: [
      "Not-Participated",
      "Participated-Won",
      "Participated-Lost",
    ...
    axios
      ...
      .then(function (response) {
        ...
        axios
          .get(response.data.project[0].ServerIP[0].NodeServerIP + API)
          .then((response) => {
            console.log("getExportLeadFilters table data : ", response.data);
            setOrderData(response.data);
          });
        ...
        axios
          .get(nodeIp + "/getExportLeadFilters")
          .then((res) => {
            if (res.data.success) {
              console.log("Defence getExportLeadFilters:", res.data.data);
              setDynamicOptions({
              ...
              <Zoom in={submitSuccess}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      Your Export Leads details were recorded successfully. You
                      can now submit another form if needed.
                    </Typography>
                ...
                >
                  ...
                  <Grid container spacing={3}>
                    {[
                      ...
                      // ["leadReferenceNo", "Lead Reference No"],
                    ...
                    <Grid item xs={12} md={4}>
                      <Controller
                        ...
                        render={({ field }) => (
                          ...
                          >
                            {dynamicOptions.defenceOrNonDefence.map((opt) => (
...
function ViewExportLeadData(props) {
  ...
  const handleDeleteRow = async (id) => {
    ...
    try {
      await axios.delete(`${ServerIp}/getExportLead`, {
            ...
            <Box sx={{ mb: 3 }}>
              ...
              >
                {[
                  ...
                  { label: "Lead Reference No", key: "leadReferenceNo" },
