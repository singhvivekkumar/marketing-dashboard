  ...
  useEffect(() => {
    axios
      ...
      .then(function (response) {
        // WE SETTING THE API
        console.log(
          "order received is looking for server IP : ",
...
function ViewOrderRecievedData(props) {
  console.log("props of viewOrderRecievedData", props);
  ...
  return (
    <>
      ...
      Dom_or_Export: "",
            ...
            <TableBody>
              {console.log("filteredSortedData of order received : ",filteredSortedData)}
...
function ExcelUploadAndValidate({ user, ServerIp }) {
  ...
  const [excelData, setExcelData] = useState([]);
   ...
   const handleDownloadSampleExcel = () => {
    const fileUrl = "/sample/Order_Received_Sample.xlsx"; // fixed public path
    const link = document.createElement("a");
    link.href = fileUrl;
    link.download = "Order_Received_Sample.xlsx";
