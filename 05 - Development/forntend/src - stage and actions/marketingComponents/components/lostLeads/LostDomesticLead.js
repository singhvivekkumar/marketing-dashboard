...
const TENDER_TYPES = ["single tender", "EOI", "RFI", "RFP", "BQ"];
const YEARS_LIST = ["2021", "2022", "2023", "2024", "2025"];
...
const LostForm = () => {
  ...
  // valueInCrWithGST: true,
  // reasonForLossing: true,
  // yearWeLost: true,
  // partners: true,
  // competitors: true,
  // competitorstechnicalScore: true,
  // competitorsquotedPrice: true,
  // beltechnicalScore: true,
  // belquotedPrice: true,
  // dateCreated: true,
  // actions: true,
  ...
  const onSubmit = (data) => {
    ...
    const formattedData = {
      ...
      competitorstechnicalScore: data.competitorstechnicalScore || "",
      competitorsquotedPrice: data.competitorsquotedPrice || "",
      beltechnicalScore: data.beltechnicalScore || "",
      belquotedPrice: data.belquotedPrice || "",
              ...
              <Zoom in={submitSuccess}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      Your Lost Leads details were recorded
                ...
                >
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={4}>
                      <Controller
                        name="competitorstechnicalScore"
                        control={control}
                        ...
                        render={({ field }) => (
                          <TextField
                            {...field}
                            fullWidth
                            label="Competitors Technical Score"
                            InputLabelProps={{ shrink: true }}
                            error={!!errors.competitorstechnicalScore}
                            helperText={
                              errors.competitorstechnicalScore?.message
                            }
                            sx={{
                              "& .MuiOutlinedInput-root": {
                                borderRadius: 3,
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            {...field}
                            fullWidth
                            label="Competitors Quoted Price"
                            InputLabelProps={{ shrink: true }}
                            error={!!errors.competitorsquotedPrice}
                            helperText={errors.competitorsquotedPrice?.message}
                            sx={{
                              "& .MuiOutlinedInput-root": {
                                borderRadius: 3,
                              },
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            {...field}
                            fullWidth
                            label="Bel Technical Score"
                            InputLabelProps={{ shrink: true }}
                            error={!!errors.beltechnicalScore}
                            helperText={errors.beltechnicalScore?.message}
                            sx={{
                              "& .MuiOutlinedInput-root": {
                                borderRadius: 3,
                              },
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            {...field}
                            fullWidth
                            label="Bel Quoted Price"
                            InputLabelProps={{ shrink: true }}
                            error={!!errors.belquotedPrice}
                            helperText={errors.belquotedPrice?.message}
                            sx={{
                              "& .MuiOutlinedInput-root": {
                                borderRadius: 3,
                              },
...
function ViewLostData(props) {
  ...
  const leadColumns = [
    ...
    { id: "valueInCrWithGST", label: "Value in CR with GST" },
    { id: "reasonForLossing", label: "Reason for Losing" },
    { id: "yearWeLost", label: "Year we Lost" },
    { id: "partners", label: "Partners" },
    { id: "competitors", label: "Competitors" },
    { id: "competitorstechnicalScore", label: " Competitors Technical Score" },
    { id: "competitorsquotedPrice", label: "Competitors Quoted Price" },
    { id: "beltechnicalScore", label: "Bel Technical Score" },
    { id: "belquotedPrice", label: "Bel Quoted Price" },
  ...
  const filteredSortedData =
    ...
    tableData
      .filter((row) => {
        ...
        const matchesResult =
          yearFilter === "all" ||
          row.yearWeLost?.toLowerCase() === yearFilter.toLowerCase();
      ...
      .sort((a, b) => {
        ...
        switch (sortBy) {
          ...
          case "yearWeLost":
            ...
            bVal = b.yearWeLost || "";
            break;
          case "valueInCrWithGST":
            aVal = parseFloat(a.valueInCrWithGST) || 0;
            bVal = parseFloat(b.valueInCrWithGST) || 0;
            break;
          case "valueInCrWithoutGST":
            aVal = parseFloat(a.valueInCrWithoutGST) || 0;
            bVal = parseFloat(b.valueInCrWithoutGST) || 0;
       ...
       ===================================================== */}
          ...
          >
            ...
            >
              ...
              <MenuItem value="valueInCrWithGST">Value (with GST, CR)</MenuItem>
            </TextField>
